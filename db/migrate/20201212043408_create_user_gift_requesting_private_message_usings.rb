class CreateUserGiftRequestingPrivateMessageUsings < ActiveRecord::Migration[6.0]
  def change
    create_table :user_gift_requesting_private_message_usings do |t|
    ...
    add_index :user_gift_requesting_private_message_usings, :created_at
